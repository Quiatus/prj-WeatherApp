...
const createDailyForecastDivs = (dayWeather) => {
    const dayAbbrTxt = getDayAbbr(dayWeather.dt);
    const dayAbbr = createElem("p", "dayAbbreviation", dayAbbrTxt);
...
const displayDailyForecast = (dfArray) => {
    ...
    const dailyForecastCont = document.getElementById("dailyForecast__contents");
    dailyForecastCont.appendChild(dayDiv);
}